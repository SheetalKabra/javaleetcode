...
//        System.out.println(solve(new ArrayList<>(Arrays.asList(1)), new ArrayList<>(Arrays.asList(1))));
    ...
    public static int solve(ArrayList<Integer> A, ArrayList<Integer> B) {
        ...
        System.out.println("Scaler.queue:"+queue);
        int cycle = 0;
        int i = 0;
...
//                if(i==15 && count==100){
//                    System.out.println("end: at 15, "+Scaler.queue.peek());
//                    break;
//                }
            }
//            if(i==15){
...
//                break;
//            }
            System.out.println("final Scaler.queue:"+queue);
            cycle++;
            queue.poll();
            System.out.println("final final Scaler.queue :"+queue);
            i++;
