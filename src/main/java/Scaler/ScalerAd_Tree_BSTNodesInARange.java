...
public class ScalerAd_Tree_BSTNodesInARange {
    ...
    public static void main(String[] args) {
        ...
        //8
//        Scaler.TreeNode root = new Scaler.TreeNode(8);
//        System.out.println(s.solve(root, 19, 22));

        //19 11 33 6 18 29 34 -1 -1 -1 -1 -1 -1 -1 -1
//        Scaler.TreeNode root = new Scaler.TreeNode(19);
//        root.left = new Scaler.TreeNode(11);
//        root.right = new Scaler.TreeNode(33);
//
//        root.left.left = new Scaler.TreeNode(6);
//        root.left.right = new Scaler.TreeNode(18);
//
//        root.right.left = new Scaler.TreeNode(29);
//        root.right.right = new Scaler.TreeNode(34);
//        System.out.println(s.solve(root, 22, 48));

        //5 2 6
//        Scaler.TreeNode root = new Scaler.TreeNode(5);
//        root.left = new Scaler.TreeNode(2);
//        root.right = new Scaler.TreeNode(6);
