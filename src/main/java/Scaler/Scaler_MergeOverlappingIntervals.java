...
//    public static Comparator<Scaler.Intervall> StuRollno = new Comparator<Scaler.Intervall>() {
//        // Method
//        public int compare(Scaler.Intervall s1, Scaler.Intervall s2) {
...
//        new Scaler.Intervall(54, 75), new Scaler.Intervall(56, 60), new Scaler.Intervall(61, 86), new Scaler.Intervall(22, 43),
//                new Scaler.Intervall(56, 87), new Scaler.Intervall(32, 53), new Scaler.Intervall(14, 81), new Scaler.Intervall(64, 65),
//                new Scaler.Intervall(9, 42), new Scaler.Intervall(12, 33), new Scaler.Intervall(22, 58), new Scaler.Intervall(84, 90),
//                new Scaler.Intervall(27, 59), new Scaler.Intervall(41, 48), new Scaler.Intervall(43, 47), new Scaler.Intervall(22, 29),
//                new Scaler.Intervall(16, 23), new Scaler.Intervall(41, 72), new Scaler.Intervall(15, 87), new Scaler.Intervall(20, 59),
//                new Scaler.Intervall(45, 84), new Scaler.Intervall(14, 77), new Scaler.Intervall(72, 93), new Scaler.Intervall(20, 58),
//                new Scaler.Intervall(47, 53), new Scaler.Intervall(25, 88), new Scaler.Intervall(5, 89), new Scaler.Intervall(34, 97),
//                new Scaler.Intervall(14, 47)


//                ArrayList<Scaler.Intervall> B = merge(new ArrayList<>(Arrays.asList(
//                        new Scaler.Intervall(54, 75), new Scaler.Intervall(56, 60), new Scaler.Intervall(61, 86), new Scaler.Intervall(22, 43),
//                        new Scaler.Intervall(56, 87), new Scaler.Intervall(32, 53), new Scaler.Intervall(14, 81), new Scaler.Intervall(64, 65),
//                        new Scaler.Intervall(9, 42), new Scaler.Intervall(12, 33), new Scaler.Intervall(22, 58), new Scaler.Intervall(84, 90),
//                        new Scaler.Intervall(27, 59), new Scaler.Intervall(41, 48), new Scaler.Intervall(43, 47), new Scaler.Intervall(22, 29),
